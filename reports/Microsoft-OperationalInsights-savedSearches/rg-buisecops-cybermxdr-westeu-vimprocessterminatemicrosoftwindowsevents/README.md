# Process Terminate Event ASIM parser for WEF Security Events
...
--- 
 properties: 
   ...
   functionParameters: >
    ...
    ),actorusername_has:string='*',dvcipaddr_has_any_prefix:dynamic=dynamic([]),dvch
    ostname_has_any:dynamic=dynamic([]),eventtype:string='*',hashes_has_any:dynamic=
   ...
   query: >
    ...
    and (array_length(targetprocess_has_any)==0 or EventData.ProcessName has_any
 ...
 id: >
  ...
  s-cybermxdr-westeu/savedSearches/vimprocessterminatemicrosoftwindowsevents
