...
--- 
 ...
 id: >
  ...
  agement(KObusTest)_LogManagement|WindowsFireawallPolicySettingsChanged
 
 name: 'LogManagement(KObusTest)_LogManagement|WindowsFireawallPolicySettingsChanged' 
