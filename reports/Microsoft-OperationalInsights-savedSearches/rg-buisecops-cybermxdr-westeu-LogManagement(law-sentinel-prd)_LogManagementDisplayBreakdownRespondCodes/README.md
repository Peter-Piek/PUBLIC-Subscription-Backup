...
--- 
 properties: 
   ...
   query: >
    ...
    = count() by scStatus
    // Oql: Type=W3CIISLog | Measure count() by scStatus // Args: {OQ: True; WorkspaceId:
 ...
 id: >
  ...
  -prd/savedSearches/LogManagement(law-sentinel-prd)_LogManagement|DisplayBreakdow
  nRespondCodes
 
 name: 'LogManagement(law-sentinel-prd)_LogManagement|DisplayBreakdownRespondCodes' 
