...
--- 
 ...
 id: >
  ...
  -prd/savedSearches/LogManagement(law-sentinel-prd)_General|AlphabeticallySortedC
  omputers
 
 name: 'LogManagement(law-sentinel-prd)_General|AlphabeticallySortedComputers' 
