...
--- 
 properties: 
   ...
   query: >
    ...
    // Oql: Type=W3CIISLog | Measure Avg(TimeTaken) by csMethod // Args: {OQ: True;
 ...
 id: >
  ...
  ogManagement|AverageHTTPRequestTimeHTTPMethod
 
 name: >
  LogManagement(log-buisecops-cybermxdr-westeu)_LogManagement|AverageHTTPRequestTi
  meHTTPMethod
