...
--- 
 ...
 id: >
  ...
  -prd/savedSearches/LogManagement(law-sentinel-prd)_LogManagement|CountOfWarningE
  vents
 
 name: 'LogManagement(law-sentinel-prd)_LogManagement|CountOfWarningEvents' 
