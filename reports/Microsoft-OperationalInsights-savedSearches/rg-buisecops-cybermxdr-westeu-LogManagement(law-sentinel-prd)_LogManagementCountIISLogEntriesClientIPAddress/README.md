...
--- 
 properties: 
   ...
   query: >
    ...
    = count() by cIP
    // Oql: Type=W3CIISLog | Measure count() by cIP // Args: {OQ: True; WorkspaceId:
 ...
 id: >
  ...
  -prd/savedSearches/LogManagement(law-sentinel-prd)_LogManagement|CountIISLogEntr
  iesClientIPAddress
 
 name: 'LogManagement(law-sentinel-prd)_LogManagement|CountIISLogEntriesClientIPAddress' 
